package com.github.gobars.l2cache.aspect.expression;
...
public class CacheOperationExpressionEvaluator extends CachedExpressionEvaluator {
  ...
  private final Map<ExpressionKey, Expression> cacheNameCache =
      new ConcurrentHashMap<ExpressionKey, Expression>(64);
  ...
  public boolean unless(
    ...
    return getExpression(this.unlessCache, methodKey, unlessExpression)
        .getValue(evalContext, boolean.class);
  }
